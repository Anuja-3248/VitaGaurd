                                ...
                                <div className="glass-card p-3 rounded-[2.5rem] shadow-glass relative">
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xl font-black text-primary-900 leading-none italic tracking-tighter">Verified <span className="text-xs font-bold text-health-cyber ml-1">Γ£ô</span></p>
                                        </div>
                                    </motion.div>
                                </div>
                            </div>
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <Link to={currentUser ? "/dashboard" : "/signup"} className="btn-premium px-12 py-6 text-xl bg-white text-slate-900 hover:bg-slate-50 border-none shadow-white/10">
                                {currentUser ? "Go to Dashboard" : "Get Started Now ΓÇö It's Free"}
                            </Link>
                        </div>
                    </motion.div>
                </div>
